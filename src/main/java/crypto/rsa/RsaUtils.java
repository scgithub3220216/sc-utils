...
public class RsaUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String input = "明文";
        // 加密
        String cipherText = rsaEncrypt(input);
        System.out.println("密文 = " + cipherText);

        //  公钥解密
        String decrypt = rsaDecrypt(cipherText);
    ...
    public static String rsaDecrypt(String cipherText) throws NoSuchAlgorithmException, InvalidKeySpecException, BadPaddingException, IllegalBlockSizeException, NoSuchPaddingException, InvalidKeyException {
    ...
    public static String rsaEncrypt(String input) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, BadPaddingException, IllegalBlockSizeException, InvalidKeyException {
